...
with open('./datasets/data/pascalvoc/coco/annotations/instances_val.json', 'r') as f:
    data = json.load(f)
...
with open('./datasets/data/pascalvoc/coco/annotations/instances_u_val.json', 'w') as f:
